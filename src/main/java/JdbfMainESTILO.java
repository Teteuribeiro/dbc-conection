...
public class JdbfMainESTILO {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\ESTILO.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table ESTILO");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into ESTILO(CODEST, NOMEST) VALUES (?,?)";
