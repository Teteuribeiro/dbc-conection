...
public class JdbfMainTFECHAM {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\TFECHAM.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table TFECHAM");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into TFECHAM(CODTFC, NOMTFC) VALUES (?,?)";
