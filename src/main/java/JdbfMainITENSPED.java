...
public class JdbfMainITENSPED {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\ITENSPED.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table ITENSPED");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into ITENSPED(NUMPED, CODPRO, CODCOR, QTD, VLRUNI) VALUES (?,?,?,?,?)";
