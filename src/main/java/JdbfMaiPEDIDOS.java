...
public class JdbfMaiPEDIDOS {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\PEDIDOS.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table PEDIDOS");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into PEDIDOS(NUMPED, DTAEMI, CODCLI, CODPGT, DTAENT, VLRDESC, PERDESC, VLRENCAR, PERENCAR, VLRTOTAL, OBSERV, MT2TOTAL) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
