...
public class JdbfMainCORES {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\CORES.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table CORES");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into CORES(CODCOR, NOMCOR) VALUES (?,?)";
