...
public class JdbfMainEMPRESAS {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\EMPRESAS.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table EMPRESAS");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into EMPRESAS(CODEMP, NOMEMP, CGC, INSEST, ENDERECO, BAIRRO, CIDADE, UF, CEP, TELEFONE, FAX) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
