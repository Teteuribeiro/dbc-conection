...
public class JdbfMainCLIENTES {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\CLIENTES.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table CLIENTES");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into CLIENTES(CODEMP, CODCLI, NOMCLI, TIPO, CGC_CPF, IEST_RG, NASCIMENTO, ENDERECO, BAIRRO, CIDADE, CEP, UF, CODPGT,TELEFONE,FAX,CELULAR,CONTATO,ECOBRANCA,EENTREGA,EMAIL,FANTASIA) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
