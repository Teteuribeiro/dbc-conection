...
public class JdbfMainORCAMENT {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\ORCAMENT.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table ORCAMENT");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into ORCAMENT(NUMORC, DTAEMI, DTAENT, CODCLI, VALICMS, VALIPI, VALFRETE, DESCRICAO1, DESCRICAO2, DESCRICAO3, DESCRICAO4, DESCRICAO5, DESCRICAO6) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
