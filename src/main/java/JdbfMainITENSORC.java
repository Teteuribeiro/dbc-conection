...
public class JdbfMainITENSORC {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\ITENSORC.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table ITENSORC");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into ITENSORC(NUMORC, CODPRO, CODCOR, QTD, VLRUNI) VALUES (?,?,?,?,?)";
