...
public class JdbfMainPRODCLI {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\PRODCLI.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table PRODCLI");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into PRODCLI(CODPRO, CODCLI) VALUES (?,?)";
