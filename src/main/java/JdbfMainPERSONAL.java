...
public class JdbfMainPERSONAL {
	...
	public static void method5(String[] args) throws Exception {	
		...
		File file = new File("C:\\Workspaces\\geral\\sistema_luciano\\arquivos_dbf_luciano\\PERSONAL.DBF");
        ...
        PreparedStatement limparTabela = conexaoComMysql.conexaoBanco().prepareStatement("truncate table PERSONAL");
        ...
        for (Map<String,Object> key : maps) {
			...
			try
			{
	            ...
	            String sql = "insert into PERSONAL(EMPRESA, SLOGAN, ENDERECO, TELEFONE, CELULAR) VALUES (?,?,?,?,?)";
